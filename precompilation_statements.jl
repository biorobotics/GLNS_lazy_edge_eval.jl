...
precompile(Tuple{Base.Threads.var"#1#2"{GLNS.var"#86#threadsfor_fun#13"{GLNS.var"#86#threadsfor_fun#11#14"{Int64, PythonCall.Wrap.PyArray{Int64, 1, true, true, Int64}, Bool, String, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Int64, Array{Array{Array{Int64, 1}, 1}, 1}, Float64, Float64, Array{Int64, 1}, Array{Array{Int64, 1}, 1}, Int64, Int64, Bool, Array{Tuple{Int64, Int64}, 1}, Base.Dict{Symbol, Any}, UInt64, Base.UnitRange{Int64}}}, Int64}})
...
precompile(Tuple{typeof(Base.:(*)), Base.SubString{String}, String, String, String})
precompile(Tuple{typeof(Base.:(==)), Base.SubString{String}, String})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:mode, :output, :verbose, :socket_port, :max_time, :new_socket_each_instance, :lazy_edge_eval, :num_iterations), Tuple{Base.SubString{String}, String, Int64, Int64, Float64, Int64, Int64, Float64}}, typeof(GLNS.solver), String, Sockets.TCPSocket, PythonCall.Wrap.PyArray{Int64, 1, true, true, Int64}, UInt64, Int64, Array{Tuple{Int64, Int64}, 1}, Bool, Int64, Int64, Array{Array{Int64, 1}, 1}, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Array{Int64, 1}, Float64, Float64, Bool, String})
