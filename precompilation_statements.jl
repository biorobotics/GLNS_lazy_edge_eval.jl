...
precompile(Tuple{Base.Threads.var"#1#2"{GLNS.var"#86#threadsfor_fun#13"{GLNS.var"#86#threadsfor_fun#11#14"{Int64, PythonCall.Wrap.PyArray{Int64, 1, true, true, Int64}, Bool, String, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Int64, Array{Array{Array{Int64, 1}, 1}, 1}, Float64, Float64, Array{Int64, 1}, Array{Array{Int64, 1}, 1}, Int64, Int64, Bool, Array{Tuple{Int64, Int64}, 1}, UInt64, Base.UnitRange{Int64}}}, Int64}})
