...
precompile(Tuple{typeof(Core.memoryref), GenericMemory{:not_atomic, Pair{GLNS.VDNodeAstar, Int64}, Core.AddrSpace{Core}(0x00)}})
precompile(Tuple{typeof(Base.getproperty), Base.Order.By{typeof(Base.last), Base.Order.ForwardOrdering}, Symbol})
precompile(Tuple{typeof(Core.memoryref), GenericMemory{:not_atomic, GLNS.VDNodeAstar, Core.AddrSpace{Core}(0x00)}})
precompile(Tuple{typeof(DataStructures.heapleft), Int64})
precompile(Tuple{typeof(DataStructures.heapright), Int64})
precompile(Tuple{typeof(Core.memoryref), GenericMemory{:not_atomic, GLNS.VDNode, Core.AddrSpace{Core}(0x00)}})
...
precompile(Tuple{Type{GLNS.VDInfo}, Array{Bool, 2}, Array{Bool, 2}, Vararg{Float64, 12}})
