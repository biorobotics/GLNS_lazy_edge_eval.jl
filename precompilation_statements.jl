...
precompile(Tuple{typeof(Base.:(var"==")), Symbol, Symbol})
...
precompile(Tuple{typeof(Base.:(var"==")), Base.UUID, Base.UUID})
...
precompile(Tuple{Base.var"##s128#281", Vararg{Any, 5}})
...
precompile(Tuple{Base.var"##open#465", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), typeof(CondaPkg.read_meta), String})
...
precompile(Tuple{typeof(CondaPkg.issameloadpath), Any, Any})
...
precompile(Tuple{typeof(Base.iterate), Base.Iterators.Zip{Tuple{Array{String, 1}, Array{String, 1}}}})
...
precompile(Tuple{Base.var"#895#898"{Base.Process}})
...
precompile(Tuple{typeof(Base.:(var"==")), Base.Dict{String, Any}, Base.Dict{String, Any}})
precompile(Tuple{typeof(Base.:(var"==")), Array{String, 1}, Array{String, 1}})
precompile(Tuple{typeof(Base.:(var"==")), Base.Dict{String, Array{String, 1}}, Base.Dict{String, Array{String, 1}}})
precompile(Tuple{typeof(Base.:(var"==")), Base.Dict{String, Base.Dict{String, String}}, Base.Dict{String, Base.Dict{String, String}}})
...
precompile(Tuple{Base.var"##printstyled#1059", Bool, Bool, Bool, Bool, Bool, Bool, Symbol, typeof(Base.printstyled), Base.TTY, String, Vararg{String}})
...
precompile(Tuple{Base.var"##with_output_color#1058", Bool, Bool, Bool, Bool, Bool, Bool, typeof(Base.with_output_color), Function, Symbol, Base.TTY, String, Vararg{String}})
...
precompile(Tuple{typeof(Base.findnext), Base.Fix2{typeof(Base.:(var"==")), String}, Array{String, 1}, Int64})
...
precompile(Tuple{Base.var"##s128#280", Vararg{Any, 5}})
...
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:color,), Tuple{Symbol}}, typeof(Base.printstyled), Base.TTY, String})
...
precompile(Tuple{Base.var"##open#465", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), typeof(TOML.parse), String})
...
precompile(Tuple{Base.var"#512#513"{Base.IOStream}})
...
precompile(Tuple{Base.var"##open#465", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CondaPkg.var"#75#84", String, Vararg{String}})
...
precompile(Tuple{Base.var"#890#891"{Base.Process}})
...
precompile(Tuple{typeof(Base._findfirst_loop), Base.Fix2{typeof(Base.:(var"==")), Symbol}, NTuple{51, Symbol}})
...
precompile(Tuple{typeof(Base._findfirst_rec), Base.Fix2{typeof(Base.:(var"==")), Symbol}, Int64, Tuple{Symbol, Symbol, Symbol}})
...
precompile(Tuple{typeof(Base._findfirst_rec), Base.Fix2{typeof(Base.:(var"==")), Symbol}, Int64, NTuple{7, Symbol}})
precompile(Tuple{typeof(Base.findfirst), Function, NTuple{11, Symbol}})
precompile(Tuple{typeof(Base._findfirst_rec), Base.Fix2{typeof(Base.:(var"==")), Symbol}, Int64, NTuple{11, Symbol}})
...
precompile(Tuple{typeof(Base.:(&)), Int64, Int64})
precompile(Tuple{typeof(Base.:(var"==")), Base.OneTo{Int64}})
...
precompile(Tuple{Base.var"##s128#703", Vararg{Any, 8}})
...
precompile(Tuple{Base.var"##s128#716", Vararg{Any, 6}})
