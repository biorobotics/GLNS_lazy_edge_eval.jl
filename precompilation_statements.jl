...
precompile(Tuple{typeof(pixi_jll.find_artifact_dir)})
...
precompile(Tuple{typeof(CondaPkg.getpref_backend)})
precompile(Tuple{typeof(CondaPkg.getpref), Type{String}, Any, Any, Any})
precompile(Tuple{typeof(CondaPkg.getpref_exe)})
precompile(Tuple{typeof(CondaPkg.getpref_env)})
precompile(Tuple{typeof(pixi_jll.is_available)})
...
precompile(Tuple{CondaPkg.var"##resolve#66", Bool, IO, Bool, Bool, typeof(CondaPkg.resolve)})
...
precompile(Tuple{typeof(CondaPkg.read_meta), IO, Type{Symbol}})
...
precompile(Tuple{CondaPkg.var"#_#9#10", Any, Any, Any, Type{CondaPkg.PkgSpec}, Any})
...
precompile(Tuple{CondaPkg.var"##is_valid_string#8", Any, Any, typeof(CondaPkg.is_valid_string), Any})
...
precompile(Tuple{CondaPkg.var"##validate_channel#13", Base.Pairs{Symbol, V, Tuple{Vararg{Symbol, N}}, NamedTuple{names, T}} where T<:Tuple{Vararg{Any, N}} where names where N where V, typeof(CondaPkg.validate_channel), Any})
...
precompile(Tuple{CondaPkg.var"##is_valid_channel#12", Any, typeof(CondaPkg.is_valid_channel), Any})
...
precompile(Tuple{Type{NamedTuple{(:timestamp, :conda_env, :load_path, :extra_path, :version, :backend, :packages, :channels, :pip_packages), T} where T<:Tuple}, Tuple{Float64, String, Array{String, 1}, Array{String, 1}, Base.VersionNumber, Symbol, Array{CondaPkg.PkgSpec, 1}, Array{CondaPkg.ChannelSpec, 1}, Array{CondaPkg.PipPkgSpec, 1}}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{names, T} where T<:Tuple where names, Type{CondaPkg.Meta}})
precompile(Tuple{CondaPkg.var"##Meta#16", Any, Any, Any, Any, Any, Any, Any, Any, Any, Type{CondaPkg.Meta}})
precompile(Tuple{Type{CondaPkg.Meta}, Float64, String, Array{String, 1}, Array{String, 1}, Base.VersionNumber, Symbol, Array{CondaPkg.PkgSpec, 1}, Array{CondaPkg.ChannelSpec, 1}, Array{CondaPkg.PipPkgSpec, 1}})
...
precompile(Tuple{typeof(CondaPkg.dedupepaths), Any})
precompile(Tuple{typeof(Base.any), Function, Array{String, 1}})
precompile(Tuple{typeof(Base._any), CondaPkg.var"#17#18"{String}, Array{String, 1}, Base.Colon})
precompile(Tuple{CondaPkg.var"#17#18"{String}, Any})
precompile(Tuple{typeof(CondaPkg.issamefile), Any, Any})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#27#28", Base.ValueIterator{Base.Dict{Base.UUID, Pkg.API.PackageInfo}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.ValueIterator{Base.Dict{Base.UUID, Pkg.API.PackageInfo}}, CondaPkg.var"#27#28"}})
precompile(Tuple{CondaPkg.var"#27#28", Any})
...
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{String, 1}, String, Base.Generator{Base.ValueIterator{Base.Dict{Base.UUID, Pkg.API.PackageInfo}}, CondaPkg.var"#27#28"}, Int64})
...
precompile(Tuple{CondaPkg.var"##_log#61", Base.Pairs{Symbol, V, Tuple{Vararg{Symbol, N}}, NamedTuple{names, T}} where T<:Tuple{Vararg{Any, N}} where names where N where V, typeof(CondaPkg._log), IO, Any})
precompile(Tuple{typeof(CondaPkg._log), Function, IO, Any})
precompile(Tuple{CondaPkg.var"##_log#60", Any, Base.Pairs{Symbol, V, Tuple{Vararg{Symbol, N}}, NamedTuple{names, T}} where T<:Tuple{Vararg{Any, N}} where names where N where V, typeof(CondaPkg._log), Function, IO, Any})
...
precompile(Tuple{CondaPkg.var"##read_deps#86", Any, typeof(CondaPkg.read_deps)})
...
precompile(Tuple{typeof(CondaPkg.getpref_openssl_version)})
...
precompile(Tuple{typeof(CondaPkg._compatible_libstdcxx_version)})
precompile(Tuple{typeof(CondaPkg.getpref_libstdcxx_version)})
precompile(Tuple{typeof(CondaPkg._compatible_libstdcxx_version), Any})
...
precompile(Tuple{CondaPkg.var"##PkgSpec#11", Any, Any, Any, Any, Type{CondaPkg.PkgSpec}, CondaPkg.PkgSpec})
...
precompile(Tuple{typeof(CondaPkg.getpref_libstdcxx_ng_version)})
...
precompile(Tuple{typeof(CondaPkg.getpref_allowed_channels)})
precompile(Tuple{typeof(CondaPkg.getpref), Type{Array{String, 1}}, Any, Any, Any})
precompile(Tuple{typeof(CondaPkg._resolve_check_allowed_channels), IO, Any, Any, Union{Nothing, Base.Set{String}}, Bool})
precompile(Tuple{typeof(CondaPkg.getpref_channel_order)})
...
precompile(Tuple{typeof(CondaPkg._resolve_order_channels!), Array{CondaPkg.ChannelSpec, 1}, Array{String, 1}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#19#21", Array{CondaPkg.ChannelSpec, 1}})
precompile(Tuple{Type{Base.Dict{K, V} where V where K}, Base.Generator{Array{CondaPkg.ChannelSpec, 1}, CondaPkg.var"#19#21"}})
precompile(Tuple{CondaPkg.var"#19#21", Any})
precompile(Tuple{typeof(Base.getproperty), CondaPkg.ChannelSpec, Symbol})
precompile(Tuple{Type{Pair{A, B} where B where A}, String, CondaPkg.ChannelSpec})
precompile(Tuple{typeof(Base.iterate), Pair{String, CondaPkg.ChannelSpec}})
...
precompile(Tuple{typeof(Base.iterate), Pair{String, CondaPkg.ChannelSpec}, Int64})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{CondaPkg.ChannelSpec, Int64}, Int64})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{CondaPkg.ChannelSpec, Int64}, Int64, Int64})
precompile(Tuple{typeof(Base.empty), Base.Dict{Any, Any}, Type{String}, Type{CondaPkg.ChannelSpec}})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{String, CondaPkg.ChannelSpec}, CondaPkg.ChannelSpec, String})
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{String, CondaPkg.ChannelSpec}, Base.Generator{Array{CondaPkg.ChannelSpec, 1}, CondaPkg.var"#19#21"}, Int64})
precompile(Tuple{typeof(Base.empty!), Array{CondaPkg.ChannelSpec, 1}})
...
precompile(Tuple{typeof(CondaPkg._extract_ordered_channels), Array{String, 1}, Base.Dict{String, CondaPkg.ChannelSpec}})
precompile(Tuple{typeof(Base.pop!), Base.Dict{String, CondaPkg.ChannelSpec}, String, Nothing})
precompile(Tuple{typeof(Base.values), Base.Dict{String, CondaPkg.ChannelSpec}})
precompile(Tuple{typeof(Base.collect), Type{CondaPkg.ChannelSpec}, Base.ValueIterator{Base.Dict{String, CondaPkg.ChannelSpec}}})
precompile(Tuple{typeof(Base.getproperty), Base.Order.By{CondaPkg.var"#20#22", Base.Order.ForwardOrdering}, Symbol})
precompile(Tuple{typeof(Base.getproperty), Base.Order.Lt{Base.Sort.var"#30#31"{Base.Order.By{CondaPkg.var"#20#22", Base.Order.ForwardOrdering}}}, Symbol})
precompile(Tuple{Base.var"##s128#278", Vararg{Any, 5}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:by,), Tuple{CondaPkg.var"#20#22"}}, typeof(Base.sort!), Array{CondaPkg.ChannelSpec, 1}})
precompile(Tuple{typeof(Base.append!), Array{CondaPkg.ChannelSpec, 1}, Array{CondaPkg.ChannelSpec, 1}})
precompile(Tuple{typeof(CondaPkg.getpref_channel_mapping)})
precompile(Tuple{typeof(CondaPkg.getpref), Type{Base.Dict{String, String}}, Any, Any, Any})
precompile(Tuple{typeof(Base.iterate), Base.Dict{String, String}})
precompile(Tuple{typeof(CondaPkg._resolve_map_channels!), Array{CondaPkg.ChannelSpec, 1}, Base.Dict{String, Base.Dict{String, CondaPkg.PkgSpec}}, Base.Dict{String, String}})
precompile(Tuple{typeof(Base.isempty), Base.Dict{String, String}})
precompile(Tuple{typeof(CondaPkg.getpref_pip_backend)})
...
precompile(Tuple{typeof(Base.iterate), Base.Dict{String, CondaPkg.PkgSpec}})
...
precompile(Tuple{typeof(Base.iterate), Base.Dict{String, CondaPkg.PkgSpec}, Int64})
precompile(Tuple{typeof(Base.iterate), Base.Dict{String, Base.Dict{String, CondaPkg.PkgSpec}}, Int64})
precompile(Tuple{typeof(CondaPkg._resolve_merge_versions), Any, Any})
precompile(Tuple{typeof(Base.split), String, String})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#40#41"{Array{Base.SubString{String}, 1}}, Array{Base.SubString{String}, 1}})
precompile(Tuple{Type{Base.Iterators.Flatten{I} where I}, Base.Generator{Array{Base.SubString{String}, 1}, CondaPkg.var"#40#41"{Array{Base.SubString{String}, 1}}}})
precompile(Tuple{typeof(Base.collect), Base.Iterators.Flatten{Base.Generator{Array{Base.SubString{String}, 1}, CondaPkg.var"#40#41"{Array{Base.SubString{String}, 1}}}}})
precompile(Tuple{CondaPkg.var"#40#41"{Array{Base.SubString{String}, 1}}, Any})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#39#42"{Base.SubString{String}}, Array{Base.SubString{String}, 1}})
precompile(Tuple{typeof(Base.iterate), Base.Generator{Array{Base.SubString{String}, 1}, CondaPkg.var"#39#42"{Base.SubString{String}}}})
precompile(Tuple{CondaPkg.var"#39#42"{Base.SubString{String}}, Any})
...
precompile(Tuple{typeof(Base.grow_to!), Array{String, 1}, Base.Iterators.Flatten{Base.Generator{Array{Base.SubString{String}, 1}, CondaPkg.var"#40#41"{Array{Base.SubString{String}, 1}}}}, Tuple{Int64, Base.Generator{Array{Base.SubString{String}, 1}, CondaPkg.var"#39#42"{Base.SubString{String}}}, Int64}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#29#34", Base.ValueIterator{Base.Dict{String, CondaPkg.PkgSpec}}})
precompile(Tuple{typeof(Base.any), Base.Generator{Base.ValueIterator{Base.Dict{String, CondaPkg.PkgSpec}}, CondaPkg.var"#29#34"}})
precompile(Tuple{CondaPkg.var"#29#34", Any})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#30#35", Base.ValueIterator{Base.Dict{String, CondaPkg.PkgSpec}}})
precompile(Tuple{typeof(Base.append!), Array{String, 1}, Base.Generator{Base.ValueIterator{Base.Dict{String, CondaPkg.PkgSpec}}, CondaPkg.var"#30#35"}})
precompile(Tuple{CondaPkg.var"#30#35", Any})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#31#36", Array{CondaPkg.ChannelSpec, 1}})
precompile(Tuple{typeof(Base.append!), Array{String, 1}, Base.Generator{Array{CondaPkg.ChannelSpec, 1}, CondaPkg.var"#31#36"}})
precompile(Tuple{CondaPkg.var"#31#36", Any})
precompile(Tuple{typeof(Base.filter!), CondaPkg.var"#32#37", Array{String, 1}})
precompile(Tuple{CondaPkg.var"#32#37", Any})
...
precompile(Tuple{typeof(Base.getproperty), Base.Order.By{CondaPkg.var"#33#38", Base.Order.ForwardOrdering}, Symbol})
precompile(Tuple{typeof(Base.getproperty), Base.Order.Lt{Base.Sort.var"#30#31"{Base.Order.By{CondaPkg.var"#33#38", Base.Order.ForwardOrdering}}}, Symbol})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:by,), Tuple{CondaPkg.var"#33#38"}}, typeof(Base.sort!), Array{CondaPkg.PkgSpec, 1}})
precompile(Tuple{CondaPkg.var"#33#38", Any})
...
precompile(Tuple{typeof(Base.getproperty), Base.Order.By{CondaPkg.var"#43#44", Base.Order.ForwardOrdering}, Symbol})
precompile(Tuple{typeof(Base.getproperty), Base.Order.Lt{Base.Sort.var"#30#31"{Base.Order.By{CondaPkg.var"#43#44", Base.Order.ForwardOrdering}}}, Symbol})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:by,), Tuple{CondaPkg.var"#43#44"}}, typeof(Base.sort!), Array{CondaPkg.PipPkgSpec, 1}})
...
precompile(Tuple{Type{Base.Iterators.Filter{F, I} where I where F}, CondaPkg.var"#45#47"{Base.Dict{String, Base.Set{CondaPkg.PkgSpec}}, Base.Dict{String, Base.Set{CondaPkg.PkgSpec}}}, Base.Set{String}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, typeof(Base.identity), Base.Iterators.Filter{CondaPkg.var"#45#47"{Base.Dict{String, Base.Set{CondaPkg.PkgSpec}}, Base.Dict{String, Base.Set{CondaPkg.PkgSpec}}}, Base.Set{String}}})
precompile(Tuple{typeof(Base.collect), Type{String}, Base.Generator{Base.Iterators.Filter{CondaPkg.var"#45#47"{Base.Dict{String, Base.Set{CondaPkg.PkgSpec}}, Base.Dict{String, Base.Set{CondaPkg.PkgSpec}}}, Base.Set{String}}, typeof(Base.identity)}})
precompile(Tuple{CondaPkg.var"#45#47"{Base.Dict{String, Base.Set{CondaPkg.PkgSpec}}, Base.Dict{String, Base.Set{CondaPkg.PkgSpec}}}, Any})
...
precompile(Tuple{typeof(Base.filter!), CondaPkg.var"#46#48", Array{String, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#49#52", Array{CondaPkg.PipPkgSpec, 1}})
precompile(Tuple{Type{Base.Dict{String, CondaPkg.PipPkgSpec}}, Base.Generator{Array{CondaPkg.PipPkgSpec, 1}, CondaPkg.var"#49#52"}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#50#53", Array{CondaPkg.PipPkgSpec, 1}})
precompile(Tuple{Type{Base.Dict{String, CondaPkg.PipPkgSpec}}, Base.Generator{Array{CondaPkg.PipPkgSpec, 1}, CondaPkg.var"#50#53"}})
...
precompile(Tuple{Type{Base.Iterators.Filter{F, I} where I where F}, CondaPkg.var"#51#54"{Base.Dict{String, CondaPkg.PipPkgSpec}, Base.Dict{String, CondaPkg.PipPkgSpec}}, Base.Set{String}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, typeof(Base.identity), Base.Iterators.Filter{CondaPkg.var"#51#54"{Base.Dict{String, CondaPkg.PipPkgSpec}, Base.Dict{String, CondaPkg.PipPkgSpec}}, Base.Set{String}}})
precompile(Tuple{typeof(Base.collect), Type{String}, Base.Generator{Base.Iterators.Filter{CondaPkg.var"#51#54"{Base.Dict{String, CondaPkg.PipPkgSpec}, Base.Dict{String, CondaPkg.PipPkgSpec}}, Base.Set{String}}, typeof(Base.identity)}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#71#79", Base.Iterators.Enumerate{Array{Array{String, 1}, 1}}})
precompile(Tuple{Type{Base.Iterators.Flatten{I} where I}, Base.Generator{Base.Iterators.Enumerate{Array{Array{String, 1}, 1}}, CondaPkg.var"#71#79"}})
precompile(Tuple{typeof(Base.collect), Base.Iterators.Flatten{Base.Generator{Base.Iterators.Enumerate{Array{Array{String, 1}, 1}}, CondaPkg.var"#71#79"}}})
precompile(Tuple{CondaPkg.var"#71#79", Any})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#70#80"{Array{String, 1}, Int64}, Array{String, 1}})
precompile(Tuple{typeof(Base.iterate), Base.Generator{Array{String, 1}, CondaPkg.var"#70#80"{Array{String, 1}, Int64}}})
precompile(Tuple{CondaPkg.var"#70#80"{Array{String, 1}, Int64}, Any})
precompile(Tuple{typeof(Base.mod1), Int64, Int64})
precompile(Tuple{Type{Array{Tuple{String, Int64}, 1}}, UndefInitializer, Tuple{Int64}})
precompile(Tuple{typeof(Base.push!), Array{Tuple{String, Int64}, 1}, Tuple{String, Int64}})
precompile(Tuple{typeof(Base.grow_to!), Array{Tuple{String, Int64}, 1}, Base.Iterators.Flatten{Base.Generator{Base.Iterators.Enumerate{Array{Array{String, 1}, 1}}, CondaPkg.var"#71#79"}}, Tuple{Tuple{Int64, Int64}, Base.Generator{Array{String, 1}, CondaPkg.var"#70#80"{Array{String, 1}, Int64}}, Int64}})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.Flatten{Base.Generator{Base.Iterators.Enumerate{Array{Array{String, 1}, 1}}, CondaPkg.var"#71#79"}}, Tuple{Tuple{Int64, Int64}, Base.Generator{Array{String, 1}, CondaPkg.var"#70#80"{Array{String, 1}, Int64}}, Int64}})
precompile(Tuple{typeof(Base.sort), Array{Tuple{String, Int64}, 1}})
precompile(Tuple{typeof(CondaPkg.getpref_offline)})
precompile(Tuple{typeof(CondaPkg.getpref), Type{Bool}, Any, Any, Any})
precompile(Tuple{typeof(Base.isempty), Array{Tuple{String, Int64}, 1}})
precompile(Tuple{typeof(Base.iterate), Array{Tuple{String, Int64}, 1}})
precompile(Tuple{Type{NamedTuple{(:label, :color), T} where T<:Tuple}, Tuple{String, Symbol}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{names, T} where T<:Tuple where names, typeof(CondaPkg._log), IO, Any, Any, Vararg{Any}})
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:label, :color), Tuple{String, Symbol}}})
precompile(Tuple{CondaPkg.var"##_log#61", Base.Pairs{Symbol, V, Tuple{Vararg{Symbol, N}}, NamedTuple{names, T}} where T<:Tuple{Vararg{Any, N}} where names where N where V, typeof(CondaPkg._log), IO, Any, Vararg{Any}})
precompile(Tuple{typeof(Base.merge), NamedTuple{(), Tuple{}}, Base.Pairs{Symbol, Any, Tuple{Symbol, Symbol}, NamedTuple{(:label, :color), Tuple{String, Symbol}}}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{names, T} where T<:Tuple where names, typeof(CondaPkg._log), Function, IO, Any, Vararg{Any}})
precompile(Tuple{typeof(Base.structdiff), NamedTuple{(:label, :color), Tuple{String, Symbol}}, Type{NamedTuple{(:label,), T} where T<:Tuple}})
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:color,), Tuple{Symbol}}})
precompile(Tuple{CondaPkg.var"##_log#60", Any, Base.Pairs{Symbol, V, Tuple{Vararg{Symbol, N}}, NamedTuple{names, T}} where T<:Tuple{Vararg{Any, N}} where names where N where V, typeof(CondaPkg._log), Function, IO, Any, Vararg{Any}})
precompile(Tuple{typeof(Base.merge), NamedTuple{(), Tuple{}}, Base.Pairs{Symbol, Symbol, Tuple{Symbol}, NamedTuple{(:color,), Tuple{Symbol}}}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:color,), Tuple{Symbol}}, typeof(Base.printstyled), Base.TTY, String, Vararg{String}})
precompile(Tuple{typeof(Base.iterate), Array{Tuple{String, Int64}, 1}, Int64})
precompile(Tuple{typeof(Base.Filesystem.cd), CondaPkg.var"#72#81"{Bool, Base.TTY, String, Array{CondaPkg.PipPkgSpec, 1}, Array{CondaPkg.PkgSpec, 1}, Array{CondaPkg.ChannelSpec, 1}}, String})
precompile(Tuple{CondaPkg.var"#72#81"{Bool, Base.TTY, String, Array{CondaPkg.PipPkgSpec, 1}, Array{CondaPkg.PkgSpec, 1}, Array{CondaPkg.ChannelSpec, 1}}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:force,), Tuple{Bool}}, typeof(Base.Filesystem.rm), String})
precompile(Tuple{Type{Pair{A, B} where B where A}, String, Bool})
precompile(Tuple{Type{Base.Dict{String, Any}}, Pair{String, Bool}})
precompile(Tuple{typeof(Base.sprint), Function, Base.Dict{String, Any}})
precompile(Tuple{typeof(TOML.Internals.Printer.print), Base.GenericIOBuffer{GenericMemory{:not_atomic, UInt8, Core.AddrSpace{Core}(0x00)}}, Base.Dict{String, Any}})
precompile(Tuple{typeof(TOML.Internals.Printer.is_tabular), Bool})
precompile(Tuple{typeof(TOML.Internals.Printer.printvalue), Nothing, Base.GenericIOBuffer{GenericMemory{:not_atomic, UInt8, Core.AddrSpace{Core}(0x00)}}, Bool, Bool})
...
precompile(Tuple{typeof(CondaPkg.pixi_cmd), Any})
precompile(Tuple{CondaPkg.var"##pixi_cmd#7", IO, typeof(CondaPkg.pixi_cmd), Any})
precompile(Tuple{typeof(pixi_jll.pixi)})
precompile(Tuple{pixi_jll.var"##pixi#4", Bool, Bool, typeof(pixi_jll.pixi)})
...
precompile(Tuple{typeof(CondaPkg.default_pixi_cache_dir)})
...
precompile(Tuple{typeof(Base.addenv), Base.Cmd, Pair{String, String}, Pair{String, String}})
precompile(Tuple{typeof(Base.cmd_gen), Tuple{Tuple{Base.Cmd}, Tuple{Base.Cmd}}})
precompile(Tuple{Type{NamedTuple{(:flags,), T} where T<:Tuple}, Tuple{Array{String, 1}}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{names, T} where T<:Tuple where names, typeof(CondaPkg._run), IO, Base.Cmd, Any})
precompile(Tuple{CondaPkg.var"##_run#65", Any, typeof(CondaPkg._run), IO, Base.Cmd, Any})
precompile(Tuple{typeof(CondaPkg.getpref_verbosity)})
precompile(Tuple{typeof(CondaPkg.getpref), Type{Int64}, Any, Any, Any})
precompile(Tuple{typeof(CondaPkg._cmdlines), Any, Any})
precompile(Tuple{typeof(Base.getproperty), Base.Cmd, Symbol})
precompile(Tuple{typeof(Base.lastindex), Array{String, 1}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{names, T} where T<:Tuple where names, typeof(CondaPkg._logblock), IO, Any})
precompile(Tuple{CondaPkg.var"##_logblock#62", Base.Pairs{Symbol, V, Tuple{Vararg{Symbol, N}}, NamedTuple{names, T}} where T<:Tuple{Vararg{Any, N}} where names where N where V, typeof(CondaPkg._logblock), IO, Any})
precompile(Tuple{typeof(Base.collect), Type{String}, Array{String, 1}})
...
precompile(Tuple{typeof(Core.kwcall), NamedTuple{names, T} where T<:Tuple where names, typeof(CondaPkg._log), Function, IO})
precompile(Tuple{CondaPkg.var"##_log#60", Any, Base.Pairs{Symbol, V, Tuple{Vararg{Symbol, N}}, NamedTuple{names, T}} where T<:Tuple{Vararg{Any, N}} where names where N where V, typeof(CondaPkg._log), Function, IO})
precompile(Tuple{CondaPkg.var"#63#64"{Base.Pairs{Symbol, Symbol, Tuple{Symbol}, NamedTuple{(:color,), Tuple{Symbol}}}, String, String}, Any})
...
precompile(Tuple{Base.var"##open#463", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), typeof(TOML.parse), String})
precompile(Tuple{typeof(CondaPkg.getpref_channel_priority)})
precompile(Tuple{Type{Pair{A, B} where B where A}, String, Array{String, 1}})
precompile(Tuple{typeof(Base._array_for), Type{String}, Array{CondaPkg.ChannelSpec, 1}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.iterate), Array{CondaPkg.ChannelSpec, 1}})
precompile(Tuple{typeof(CondaPkg.specstr), CondaPkg.ChannelSpec})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CondaPkg.var"#73#82", Array{CondaPkg.PkgSpec, 1}})
precompile(Tuple{Type{Base.Dict{String, Any}}, Base.Generator{Array{CondaPkg.PkgSpec, 1}, CondaPkg.var"#73#82"}})
precompile(Tuple{CondaPkg.var"#73#82", Any})
precompile(Tuple{typeof(CondaPkg.pixispec), CondaPkg.PkgSpec})
...
precompile(Tuple{typeof(Base.indexed_iterate), Pair{String, Base.Dict{String, Any}}, Int64})
precompile(Tuple{typeof(Base.indexed_iterate), Pair{String, Base.Dict{String, Any}}, Int64, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, TOML.Internals.Printer.var"#4#6", Base.ValueIterator{Base.Dict{String, Any}}})
precompile(Tuple{typeof(Base.all), Base.Generator{Base.ValueIterator{Base.Dict{String, Any}}, TOML.Internals.Printer.var"#4#6"}})
...
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:indent, :first_block, :sorted, :by, :inline_tables), Tuple{Int64, Bool, Bool, typeof(Base.identity), Base.IdSet{Base.Dict{String, V} where V}}}, typeof(TOML.Internals.Printer.print_table), Nothing, Base.GenericIOBuffer{GenericMemory{:not_atomic, UInt8, Core.AddrSpace{Core}(0x00)}}, Base.Dict{String, Any}, Array{String, 1}})
precompile(Tuple{typeof(TOML.Internals.Printer.printvalue), Nothing, Base.GenericIOBuffer{GenericMemory{:not_atomic, UInt8, Core.AddrSpace{Core}(0x00)}}, String, Bool})
...
precompile(Tuple{typeof(TOML.Internals.Printer.printvalue), Nothing, Base.GenericIOBuffer{GenericMemory{:not_atomic, UInt8, Core.AddrSpace{Core}(0x00)}}, Array{String, 1}, Bool})
precompile(Tuple{typeof(Base.eachline), String})
precompile(Tuple{typeof(Base.collect), Type{String}, Base.EachLine{Base.IOStream}})
precompile(Tuple{Base.var"#510#511"{Base.IOStream}})
precompile(Tuple{typeof(Base.cmd_gen), Tuple{Tuple{Base.SubString{String}}, Tuple{Base.SubString{String}}, Tuple{String}}})
precompile(Tuple{typeof(CondaPkg._run), IO, Base.Cmd, Any})
precompile(Tuple{typeof(Base.Libc.time)})
precompile(Tuple{Base.var"##open#463", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CondaPkg.var"#75#84", String, Vararg{String}})
precompile(Tuple{CondaPkg.var"#75#84", Any})
...
precompile(Tuple{typeof(CondaPkg.write_meta), IO, Symbol})
...
precompile(Tuple{typeof(PythonCall.pygt), Type{Bool}, PythonCall.Py, Int64})
precompile(Tuple{typeof(PythonCall.C.PyObject_RichCompareBool), PythonCall.Py, PythonCall.Py, Int32})
precompile(Tuple{typeof(PythonCall.pylist), Array{String, 1}})
precompile(Tuple{typeof(PythonCall.pysetattr), PythonCall.Py, String, PythonCall.Py})
precompile(Tuple{Type{PythonCall.Py}, String})
precompile(Tuple{typeof(PythonCall.pystr), String})
precompile(Tuple{typeof(PythonCall.Core.pystr_fromUTF8), String})
precompile(Tuple{typeof(PythonCall.C.PyObject_SetAttr), PythonCall.Py, PythonCall.Py, PythonCall.Py})
precompile(Tuple{typeof(PythonCall.pydict)})
precompile(Tuple{typeof(PythonCall.pyexec), String, PythonCall.Py})
precompile(Tuple{typeof(PythonCall.pyexec), String, PythonCall.Py, Nothing})
precompile(Tuple{typeof(Base.getindex), PythonCall.Py, String})
precompile(Tuple{typeof(PythonCall.pycopy!), PythonCall.Py, PythonCall.Py})
...
precompile(Tuple{typeof(Base.findfirst), Function, NTuple{51, Symbol}})
precompile(Tuple{typeof(Base._findfirst_loop), Base.Fix2{typeof(Base.:(==)), Symbol}, NTuple{51, Symbol}})
...
precompile(Tuple{PythonCall.Utils.var"##s29#5", Any, Any, Any})
precompile(Tuple{PythonCall.Utils.var"##s29#6", Any, Any, Any})
precompile(Tuple{PythonCall.Utils.var"##s29#4", Any, Any, Any})
...
precompile(Tuple{PythonCall.Convert.var"##s312#38", Any, Any, Any})
...
precompile(Tuple{typeof(Core.memoryref), GenericMemory{:not_atomic, PythonCall.Py, Core.AddrSpace{Core}(0x00)}})
precompile(Tuple{Base.Iterators.var"#7#8"{Tuple{Array{PythonCall.Py, 1}, Array{Array{String, 1}, 1}}}, Int64})
precompile(Tuple{Base.Iterators.var"#5#6"{Tuple{Array{PythonCall.Py, 1}, Array{Array{String, 1}, 1}}}, Int64})
...
precompile(Tuple{typeof(PythonCall.pyconvert_return), Bool})
...
precompile(Tuple{typeof(PythonCall.Core.py_finalizer), PythonCall.Py})
...
precompile(Tuple{Type{PythonCall.PyList{Any}}, Array{String, 1}})
precompile(Tuple{typeof(PythonCall.JlWrap.Cjl.PyJuliaValue_New), PythonCall.Py, Any})
precompile(Tuple{typeof(PythonCall.C.asptr), PythonCall.Py})
...
precompile(Tuple{typeof(PythonCall.Core.pytuple_setitem), PythonCall.Py, Int64, Int64})
precompile(Tuple{typeof(PythonCall.Core.incref), PythonCall.Py})
precompile(Tuple{typeof(PythonCall.C.PyTuple_SetItem), PythonCall.Py, Int64, PythonCall.Py})
precompile(Tuple{typeof(PythonCall.C.PyObject_SetItem), PythonCall.Py, PythonCall.Py, PythonCall.Py})
precompile(Tuple{typeof(Base.setindex!), PythonCall.Py, String, String})
precompile(Tuple{typeof(PythonCall.pysetitem), PythonCall.Py, String, String})
precompile(Tuple{typeof(PythonCall.C.PyObject_GetAttr), PythonCall.Py, PythonCall.Py})
precompile(Tuple{typeof(PythonCall.Core.pytuple_setitem), PythonCall.Py, Int64, PythonCall.Py})
precompile(Tuple{Type{Ptr{Nothing}}, Ptr{PythonCall.C.PyObject}})
precompile(Tuple{typeof(PythonCall.pydel!), PythonCall.Py})
precompile(Tuple{typeof(PythonCall.Core.pytypecheckfast), PythonCall.Py, UInt32})
precompile(Tuple{typeof(PythonCall.C.Py_TypeCheckFast), PythonCall.Py, UInt32})
...
precompile(Tuple{typeof(PythonCall.C.PySequence_Contains), PythonCall.Py, PythonCall.Py})
precompile(Tuple{typeof(Base.getindex), PythonCall.Py, Int64})
precompile(Tuple{typeof(PythonCall.Convert.pyconvert_get_rules), Type, PythonCall.Py})
precompile(Tuple{typeof(PythonCall.pyis), PythonCall.Py, PythonCall.Py})
precompile(Tuple{PythonCall.Convert.var"#pyisin#11", PythonCall.Py, Array{PythonCall.Py, 1}})
precompile(Tuple{typeof(Base.push!), Array{PythonCall.Py, 1}, PythonCall.Py})
precompile(Tuple{typeof(Base.print), Base.GenericIOBuffer{GenericMemory{:not_atomic, UInt8, Core.AddrSpace{Core}(0x00)}}, PythonCall.Py})
...
precompile(Tuple{typeof(Base.Order.lt), Base.Order.ReverseOrdering{Base.Order.ForwardOrdering}, Tuple{PythonCall.PyConvertPriority, Int64}, Tuple{PythonCall.PyConvertPriority, Int64}})
...
precompile(Tuple{PythonCall.Convert.var"#36#37"{UInt64, typeof(PythonCall.Convert.pyconvert_rule_int)}, PythonCall.Py})
precompile(Tuple{typeof(PythonCall.Core.pyisFalse), PythonCall.Py})
precompile(Tuple{typeof(PythonCall.C.PyObject_GetItem), PythonCall.Py, PythonCall.Py})
precompile(Tuple{PythonCall.Convert.var"#36#37"{Tuple{Int64}, typeof(PythonCall.Convert.pyconvert_rule_iterable)}, PythonCall.Py})
precompile(Tuple{typeof(PythonCall.Core.pyisnone), PythonCall.Py})
precompile(Tuple{Type{PythonCall.PyArray{Int64, 2, true, true, Int64}}, Array{Int64, 2}})
precompile(Tuple{typeof(PythonCall.JlWrap.pyjlarray_array_interface), Array{Int64, 2}})
precompile(Tuple{PythonCall.Convert.var"#36#37"{Tuple{Int64, Int64}, typeof(PythonCall.Convert.pyconvert_rule_iterable)}, PythonCall.Py})
precompile(Tuple{PythonCall.Convert.var"#36#37"{String, typeof(PythonCall.Convert.pyconvert_rule_str)}, PythonCall.Py})
...
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:socket_port, :max_time, :max_removals_cap, :output, :max_removal_fraction, :new_socket_each_instance, :num_iterations, :mode, :verbose, :lazy_edge_eval, :latest_improvement, :first_improvement), Tuple{Int64, Float64, Int64, Base.SubString{String}, Float64, Int64, Float64, Base.SubString{String}, Int64, Int64, Float64, Float64}}, typeof(GLNS.solver), String, Sockets.TCPSocket, PythonCall.PyArray{Int64, 1, true, true, Int64}, UInt64, Int64, Array{Tuple{Int64, Int64}, 1}, Bool, Int64, Int64, Array{Array{Int64, 1}, 1}, PythonCall.PyArray{Int64, 2, true, true, Int64}, Array{Int64, 1}, Float64, Float64, Bool, String})
precompile(Tuple{typeof(Base.to_indices), PythonCall.PyArray{Int64, 1, true, true, Int64}, Tuple{Base.UnitRange{Int64}}})
precompile(Tuple{typeof(Base._getindex), Base.IndexLinear, PythonCall.PyArray{Int64, 1, true, true, Int64}, Base.UnitRange{Int64}})
precompile(Tuple{typeof(Base.uvfinalize), Sockets.TCPSocket})
precompile(Tuple{PythonCall.C.var"#39#45"})
precompile(Tuple{PythonCall.C.var"#35#41"})
