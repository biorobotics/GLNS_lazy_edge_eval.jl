...
precompile(Tuple{typeof(Base._array_for), Type{String}, Array{CondaPkg.PkgSpec, 1}, Base.HasShape{1}})
precompile(Tuple{Type{Base.LinearIndices{N, R} where R<:Tuple{Vararg{Base.AbstractUnitRange{Int64}, N}} where N}, Array{String, 1}})
precompile(Tuple{typeof(Base._array_for), Type{String}, Array{CondaPkg.PipPkgSpec, 1}, Base.HasShape{1}})
...
precompile(Tuple{CondaPkg.var"#51#59"{Array{String, 1}, Int64}, Any})
...
precompile(Tuple{typeof(Base.grow_to!), Array{Tuple{String, Int64}, 1}, Base.Iterators.Flatten{Base.Generator{Base.Iterators.Enumerate{Array{Array{String, 1}, 1}}, CondaPkg.var"#52#58"}}, Tuple{Tuple{Int64, Int64}, Base.Generator{Array{String, 1}, CondaPkg.var"#51#59"{Array{String, 1}, Int64}}, Int64}})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.Flatten{Base.Generator{Base.Iterators.Enumerate{Array{Array{String, 1}, 1}}, CondaPkg.var"#52#58"}}, Tuple{Tuple{Int64, Int64}, Base.Generator{Array{String, 1}, CondaPkg.var"#51#59"{Array{String, 1}, Int64}}, Int64}})
...
precompile(Tuple{CondaPkg.var"##_log#42", Base.Pairs{Symbol, V, Tuple{Vararg{Symbol, N}}, NamedTuple{names, T}} where T<:Tuple{Vararg{Any, N}} where names where N where V, typeof(CondaPkg._log), IO, Any, Vararg{Any}})
...
precompile(Tuple{CondaPkg.var"##_log#41", Any, Base.Pairs{Symbol, V, Tuple{Vararg{Symbol, N}}, NamedTuple{names, T}} where T<:Tuple{Vararg{Any, N}} where names where N where V, typeof(CondaPkg._log), Function, IO, Any, Vararg{Any}})
...
precompile(Tuple{typeof(CondaPkg._resolve_conda_remove_all), Any, Any})
precompile(Tuple{typeof(CondaPkg._verbosity_flags)})
precompile(Tuple{typeof(CondaPkg._verbosity)})
precompile(Tuple{typeof(CondaPkg.getpref), Type{Int64}, Any, Any, Any})
precompile(Tuple{typeof(Base.cmd_gen), Tuple{Tuple{Base.SubString{String}}, Tuple{Array{String, 1}}, Tuple{Base.SubString{String}}, Tuple{Base.SubString{String}}, Tuple{String}, Tuple{Base.SubString{String}}}})
precompile(Tuple{Type{NamedTuple{(:io,), T} where T<:Tuple}, Tuple{Base.TTY}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{names, T} where T<:Tuple where names, typeof(CondaPkg.conda_cmd), Any})
precompile(Tuple{CondaPkg.var"##conda_cmd#2", IO, typeof(CondaPkg.conda_cmd), Any})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{names, T} where T<:Tuple where names, typeof(MicroMamba.cmd), Any})
precompile(Tuple{MicroMamba.var"##cmd#5", IO, typeof(MicroMamba.cmd), Any})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{names, T} where T<:Tuple where names, typeof(MicroMamba.cmd)})
precompile(Tuple{MicroMamba.var"##cmd#4", IO, typeof(MicroMamba.cmd)})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{names, T} where T<:Tuple where names, typeof(MicroMamba.executable)})
...
precompile(Tuple{typeof(Base.cmd_gen), Tuple{Tuple{String}, Tuple{Base.SubString{String}}, Tuple{String}}})
...
precompile(Tuple{CondaPkg.var"##_run#43", Any, typeof(CondaPkg._run), IO, Base.Cmd, Any})
...
precompile(Tuple{CondaPkg.var"##_log#41", Any, Base.Pairs{Symbol, V, Tuple{Vararg{Symbol, N}}, NamedTuple{names, T}} where T<:Tuple{Vararg{Any, N}} where names where N where V, typeof(CondaPkg._log), Function, IO})
precompile(Tuple{CondaPkg.var"#44#45"{String, String}, Any})
precompile(Tuple{typeof(Base.print), Base.TTY, String})
precompile(Tuple{Base.var"##printstyled#1059", Bool, Bool, Bool, Bool, Bool, Bool, Symbol, typeof(Base.printstyled), Base.TTY, String})
...
precompile(Tuple{typeof(Core.kwcall), NamedTuple{names, T} where T<:Tuple where names, typeof(CondaPkg._resolve_conda_install), Vararg{Any, 4}})
precompile(Tuple{CondaPkg.var"##_resolve_conda_install#36", Any, typeof(CondaPkg._resolve_conda_install), Vararg{Any, 4}})
precompile(Tuple{typeof(Base.length), Array{CondaPkg.PkgSpec, 1}})
precompile(Tuple{typeof(CondaPkg.specstr), CondaPkg.PkgSpec})
...
precompile(Tuple{typeof(Base.cmd_gen), Tuple{Tuple{String}, Tuple{Array{String, 1}}, Tuple{Base.SubString{String}}, Tuple{Base.SubString{String}}, Tuple{String}, Tuple{Base.SubString{String}}, Tuple{Base.SubString{String}}, Tuple{Array{String, 1}}}})
...
precompile(Tuple{Base.var"##open#465", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CondaPkg.var"#53#60", String, Vararg{String}})
...
precompile(Tuple{typeof(Base._findfirst_loop), Base.Fix2{typeof(Base.:(var"==")), Symbol}, NTuple{49, Symbol}})
