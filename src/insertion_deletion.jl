...
"""
function remove_insert(current::Tour, best::Tour, dist::Array{Int64,3}, member::Array{Int64,1},
	...
	vec_score = 100 * (current.cost - trial.cost)./current.cost
  if vec_score[1] < 0
    score = 0
  elseif vec_score[1] > 0
    score = vec_score[1]
  else
    if vec_score[2] < 0
      score = 0
...
"""
function pdf_select(weights::Array{Array{Int64,1},1}, power::Float64)
...
function randpdf_insertion!(tour::Array{Int64,1}, sets_to_insert::Array{Int64,1},
							dist::Array{Int64, 3}, setdist::Distsv,
							sets::Array{Any, 1}, power::Float64, noise::Power)

    mindist = [[typemax(Int64),typemax(Int64)] for i=1:length(sets_to_insert)]
...
"""
@inline function insert_lb(tour::Array{Int64,1}, dist::Array{Int64,3}, set::Array{Int64, 1},
...
@inline function insert_subset_lb(tour::Array{Int64,1}, dist::Array{Int64,3}, set::Array{Int64, 1},
							setind::Int, setdist::Distsv, noise::Float64)
	best_cost = [typemax(Int64), typemax(Int64)]
	bestv = 0
	bestpos = 0
...
function initial_tour!(lowest::Tour, dist::Array{Int64, 3}, sets::Array{Any, 1},
	...
	best = Tour(Int64[], [typemax(Int64), typemax(Int64)])
...
function random_insertion!(tour::Array{Int64,1}, sets_to_insert::Array{Int64,1},
						   dist::Array{Int64, 3}, sets::Array{Any, 1}, setdist::Distsv)
...
function random_initial_tour!(tour::Array{Int64,1}, sets_to_insert::Array{Int64,1},
							  dist::Array{Int64, 3}, sets::Array{Any, 1})
...
"""
function worst_removal!(tour::Array{Int64,1}, dist::Array{Int64, 3},
...
function distance_removal!(tour::Array{Int64,1}, dist::Array{Int64, 3},
							   num_to_remove::Int64, member::Array{Int64,1}, power::Float64)
    deleted_sets = Array{Int}(undef, 0)
    ...
    while length(deleted_sets) < num_to_remove
        ...
        mindist = [[typemax(Int64), typemax(Int64)] for i in 1:length(tour)]
        for i = 1:length(tour)
...
"""
function worst_vertices(tour::Array{Int64, 1}, dist::Array{Int64, 3})
    removal_cost = [[typemax(Int64), typemax(Int64)] for i in 1:length(tour)]
    @inbounds for i = 1:length(tour)
        if i == 1
